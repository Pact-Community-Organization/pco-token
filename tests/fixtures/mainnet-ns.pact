;; mainnet-ns.pact — the LIVE Kadena mainnet01 "ns" module source, fetched
;; byte-true via (at "code" (describe-module "ns")) on chain 0, 2026-07-20.
;; Module hash at fetch: jXT9VNDw_Wn0wsWQcLCejEQfAdpyA_GUjeINHG9Z3aU
;; Purpose: REPL rehearsal of principal-namespace creation against the
;; exact code mainnet will execute. DO NOT EDIT the module body.
